...
cdef void transform_one(
    ...
    cdef double cosij, sinij, dxij, dyij
    ...
    # on W face
        ...
        # x
        stxyz[0] = X[jj_int, ii_int] - sinij * dyij * ny

        # y
        stxyz[1] = Y[jj_int, ii_int] + cosij * dyij * ny
    ...
    # on S face
        ...
        # x
        stxyz[0] = X[jj_int, ii_int] + cosij * dxij * nx

        # y
        stxyz[1] = Y[jj_int, ii_int] + sinij * dxij * nx
