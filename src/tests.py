...
lakes = [
    {"name": "ageri", "particles": [689500, 220000]},
    {"name": "biel", "particles": [580269, 215464]},
    {"name": "caldonazzo", "particles": [674000, 5098000]},
    {"name": "garda", "particles": [628000, 5050000]},
    {"name": "geneva", "particles": [531350, 145124]},
    {"name": "greifensee", "particles": [693199, 245870]},
    {"name": "hallwil", "particles": [658735, 237277]},
    {"name": "joux", "particles": [511380, 165584]},
    {"name": "lugano", "particles": [718659, 94426]},
    {"name": "murten", "particles": [572990, 198024]},
    {"name": "stmoritz", "particles": [784814, 152079]},
    {"name": "zurich", "particles": [697899, 230725]}
]
...
for lake in lakes:
    try:
        ...
        out = preprocess("setup_verification", lake["name"], start, end, particles)
        ...
        plot_particle_tracking(out["working_dir"], out["x0"], out["y0"], out["x1"], out["y1"], lake["name"], save=True, plot=False, grid_type=out["grid_type"])
